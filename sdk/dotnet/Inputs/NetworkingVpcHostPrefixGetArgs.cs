...
namespace Pulumi.Coreweave.Inputs
{
    ...
    public sealed class NetworkingVpcHostPrefixGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The configuration for a secondary host prefix.
        /// </summary>
        [Input("ipam")]
        public Input<Inputs.NetworkingVpcHostPrefixIpamGetArgs>? Ipam { get; set; }
        ...
        public NetworkingVpcHostPrefixGetArgs()
        {
        }
        public static new NetworkingVpcHostPrefixGetArgs Empty => new NetworkingVpcHostPrefixGetArgs();
    }
}
